    ...
    return (
        <footer className="bg-black">
            <section className="w-full flex py-6">
                ...
                <div className="w-1/3 flex flex-col items-center">
                    <h1 className="text-white  flex-col items-center mx-16">Hecho por Rodrigo Cabello Erencia</h1>
                    <h1 className="text-white  flex-col items-center mx-16 hover:text-[#f3bc04] hover:underline decoration-current[#f3bc04]">vanguardia@gmail.com</h1>
                </div>
            </section>
