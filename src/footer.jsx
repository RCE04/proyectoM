    ...
    return (
        <footer className="bg-black">
            <section className="w-full flex flex-col md:flex-row py-6">
                ...
                <div className="w-full md:w-[2px] md:h-15 bg-white/50 mb-4 md:"></div>

                <div className="md:w-1/3 w-full flex flex-col items-center">
                    <div className="flex ml-16 mb-5 mr-2">
                        <img src="social.png" alt="WhatsApp" className="w-7" />
                        <a href="" className="text-white  flex-col items-center mr-16 pt-0.5 hover:text-[#f3bc04] hover:underline decoration-current[#f3bc04]">+34 722-341-235</a>
                    </div>
                    <div className="flex ml-16">
